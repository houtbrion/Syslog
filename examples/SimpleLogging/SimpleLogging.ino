...
#if defined(SYSLOG_USE_SOFTWARE_SERIAL) || defined(SYSLOG_USE_HARDWARE_SERIAL)
#define USE_SERIAL
#endif

#ifdef SYSLOG_USE_NETWORK
#ifdef USE_ETHERNET
byte mac[] = { 0xDE, 0xAD, 0xBE, 0xEF, 0xF0, 0x0D };
#endif /* USE_ETHERNET */

UDP_CLASS udpClient;
#endif /* SYSLOG_USE_NETWORK */

#ifdef SYSLOG_USE_NTP
UDP_CLASS ntpUDP;
NTPClient timeClient(ntpUDP, NTP_SERVER, TZ_OFFSET, 60000);
#endif /* SYSLOG_USE_NTP */

/*
 * Serial Mega
 * Serial1 MKR
 */
#ifdef SYSLOG_USE_SOFTWARE_SERIAL
SoftwareSerial mySerial(SOFT_SERIAL_RX, SOFT_SERIAL_TX); // RX, TX
#endif /* SYSLOG_USE_SOFTWARE_SERIAL */

Syslog syslog(DEVICE_HOSTNAME, APP_NAME, LOG_KERN);

#ifdef SYSLOG_USE_FILE
File logfile;
#endif /* SYSLOG_USE_FILE */

#ifdef SYSLOG_USE_RTC
RTC_CLASS rtc = RTC_CLASS(&Wire);
#endif /* SYSLOG_USE_RTC */
...
//#ifdef USE_SERIAL
#ifdef SYSLOG_USE_HARDWARE_SERIAL
...
#endif /* SYSLOG_USE_HARDWARE_SERIAL */
#ifdef SYSLOG_USE_SOFTWARE_SERIAL
